...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.meygvks.mongodb.net/?retryWrites=true&w=majority`;
console.log(uri)
...
async function run(){
  try{
    const appointmentOptionsCollection= client.db('doctorsPortalLisbon').collection('appointmentOptionsCollection')
  ...
  app.get('/users/admin/:email',async(req,res)=>{
    ...
    // temporary to update price in database on appointmentOptions
